            ...
            <aside className="w-64 border-r border-[#EBE3D5] flex flex-col justify-between py-8 px-6 shrink-0">
                <div>
                    ...
                    <nav className="space-y-1 px-1 py-2 border-b border-[#EBE3D5]">
                        ...
                        <NavItem icon={<BookAIcon size={18} />} label="Agenda" />
                        <NavItem icon={<BookOpen size={18} />} label="Tesis" />
                        <NavItem icon={<Users size={18} />} label="Alumnos" />
                        <NavItem icon={<ContactRound size={18} />} label="Prerregistro" active />
            ...
            <main className="flex-1 flex flex-col h-screen overflow-hidden relative">
                ...
                <div className="flex-1 flex overflow-hidden">
                    ...
                    <section className="flex-1 px-8 py-6 flex flex-col overflow-hidden">
                        <h1 className="text-[28px] font-medium mb-6 text-stone-800">Prerregistro de Alumnos</h1>
                        ...
                        <div className="bg-[#FAF8F5] rounded-2xl border border-[#EBE3D5] overflow-auto flex-1">
                            <table className="w-full text-left border-collapse whitespace-nowrap">
                                ...
                                <tbody className="divide-y divide-[#EBE3D5]">
                                    <TableRow code="ASP001" name="Juan Pérez" prog="Maestría en IA" status="Pendiente" statusColor="bg-[#D8C4B6]" />
                                    <TableRow code="ASP002" name="María García" prog="Doctorado en Ciencias" status="En Revisión" statusColor="bg-[#DBD3C8]" />
                                    <TableRow code="ASP003" name="Luis Rodríguez" prog="Maestría en IA" status="Aceptado" statusColor="bg-[#E6D5C5]" />
                                </tbody>
                            </table>
                        </div>
                    </section>
                        ...
                        <div className="p-8">
                            <div className="flex justify-between items-start mb-6">
                                <h2 className="text-xl font-medium leading-tight text-stone-800">
                                    Detalles Aspirante<br /><span className="text-stone-500 font-normal">(ASP001)</span>
                                </h2>
                            ...
                            <div className="flex gap-6 border-b border-[#EBE3D5] mb-2 text-sm overflow-x-auto whitespace-nowrap scrollbar-hide">
                                <button className="pb-3 text-stone-800 font-semibold border-b-2 border-[#C9B29B]">Datos</button>
                                <button className="pb-3 text-stone-500 hover:text-stone-800 transition-colors">Documentos</button>
                            </div>

                            <div className="space-y-4 mb-10">
                                <DocumentCard title="CURP" />
                                <DocumentCard title="Acta de Nacimiento" />
                                <DocumentCard title="Cédula Profesional" />
                            </div>
...
function NavItem({ icon, label, active }) {
    return (
        <div className={`flex items-center gap-3 px-4 py-2.5 rounded-xl cursor-pointer transition-all ${active
            ? 'bg-white shadow-sm font-medium text-stone-800 border-none'
            : 'text-stone-600 hover:bg-[#F0EBE1]'
            }`}>
            <div className={active ? "text-stone-800" : "text-stone-400"}>{icon}</div>
