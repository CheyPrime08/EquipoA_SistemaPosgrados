            ...
            <main className="flex-1 flex flex-col">
                ...
                <div className="p-10 space-y-12">
                    ...
                    <div className="bg-[#EBE3D5] p-8 rounded-[40px] max-w-3xl">
                        ...
                        />
                        <div className="bg-white border border-stone-400 h-10 rounded-md mb-6 w-full flex items-center px-4 text-sm">
                    ...
                    <div className="bg-[#EBE3D5] p-8 rounded-[40px]">
                        ...
                        <div className="bg-white rounded-[30px] p-10 flex gap-12 justify-start items-center flex-wrap">
                            ...
                            {reportes.map((archivo, index) => (
                                ...
                                <FileIcon
                                    key={index}
                                    label={archivo.nombre_archivo}
                                    url={archivo.url_descarga}
                                />
...
function NavItem({ icon, label, active, to }) {
    ...
    return (
        <div
            ...
            ${active ? 'bg-[#EBE3D5] shadow-sm text-stone-900 font-bold'
                    : 'text-stone-600 hover:bg-[#EBE3D5]/50'}`}
        >
            {icon}
